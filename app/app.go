...
import (
	...
	"github.com/mingderwang/did/x/did"
	didkeeper "github.com/mingderwang/did/x/did/keeper"
	didtypes "github.com/mingderwang/did/x/did/types"
...
var (
	DefaultCLIHome = os.ExpandEnv("$HOME/.didcli")
	DefaultNodeHome = os.ExpandEnv("$HOME/.didd")
...
func NewInitApp(
  ...
  // this line is used by starport scaffolding # 4
	...
	app.mm = module.NewManager(
		...
		did.NewAppModule(app.didKeeper, app.bankKeeper),
